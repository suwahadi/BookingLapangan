        ...
        <aside class="hidden md:flex md:flex-col w-72 bg-gray-900 text-white shrink-0 shadow-2xl z-50">
            <div class="px-8 py-8 flex flex-col h-full">
                ...
                <nav class="flex-1 min-h-0 space-y-2 overflow-y-auto pr-2 scrollbar-hide">
                    ...
                    <a href="{{ route('admin.pages.index') }}" wire:navigate class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.pages.*') ? 'bg-gray-800 text-white border border-gray-700' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} rounded-2xl font-bold transition-all group">
