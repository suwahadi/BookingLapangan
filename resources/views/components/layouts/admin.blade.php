...
<head>
    ...
    <title>{{ $title ?? 'Admin - BookingLapangan' }}</title>
...
<body class="bg-gray-50 min-h-screen font-sans text-gray-900">
        ...
        <aside class="hidden md:flex md:flex-col w-72 bg-gray-900 text-white shrink-0 shadow-2xl z-50">
            <div class="px-8 py-8 flex flex-col h-full">
                ...
                <nav class="flex-1 min-h-0 space-y-2 overflow-y-auto pr-2 scrollbar-hide">
                    ...
                    <p class="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 mb-4 mt-8 ml-2">System</p>
                ...
                <div class="mt-auto pt-8 border-t border-gray-800">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 overflow-hidden">
                            <p class="text-sm font-black text-white truncate lowercase tracking-tight">{{ Auth::user()->name }}</p>
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <header class="bg-white border-b border-gray-100 flex items-center justify-between px-6 h-16 shrink-0 md:hidden">
                <a href="/" class="flex items-center gap-2">
                     ...
                     <span class="font-display font-black tracking-tighter">BookingLapangan</span>
                </a>
    ...
    <div class="md:hidden fixed bottom-6 left-6 right-6 z-50">
        <div class="bg-gray-900 shadow-2xl rounded-[2rem] border border-white/10 p-3 flex items-center justify-around backdrop-blur-md bg-opacity-90">
            <a href="{{ route('admin.dashboard') }}" wire:navigate class="flex flex-col items-center gap-1 p-3 {{ request()->routeIs('admin.dashboard') ? 'bg-indigo-600 text-white rounded-2xl shadow-lg shadow-indigo-500/30' : 'text-gray-400' }}">
            ...
            <a href="{{ route('admin.bookings.index') }}" wire:navigate class="flex flex-col items-center gap-1 p-3 {{ request()->routeIs('admin.bookings.*') ? 'bg-indigo-600 text-white rounded-2xl shadow-lg shadow-indigo-500/30' : 'text-gray-400' }}">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
                <span class="text-[8px] font-black uppercase tracking-widest">Book</span>
            </a>
            <a href="{{ route('admin.venues.index') }}" wire:navigate class="flex flex-col items-center gap-1 p-3 {{ request()->routeIs('admin.venues.*') ? 'bg-indigo-600 text-white rounded-2xl shadow-lg shadow-indigo-500/30' : 'text-gray-400' }}">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                <span class="text-[8px] font-black uppercase tracking-widest">Venue</span>
            </a>
            <button @click="sidebarOpen = true" class="flex flex-col items-center gap-1 p-3 text-gray-400">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7" /></svg>
