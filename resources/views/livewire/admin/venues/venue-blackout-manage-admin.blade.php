<div class="space-y-10">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
            ...
            <h1 class="text-4xl font-black text-gray-900 tracking-tight font-display italic uppercase">Venue <span class="text-rose-600">Blackout</span></h1>
            <p class="text-gray-500 font-bold mt-1 tracking-tight">Atur hari libur atau penutupan sementara untuk seluruh area {{ $venue->name }}.</p>
        </div>
    </div>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-[2.5rem] p-10 shadow-2xl border border-gray-50 sticky top-10">
                <div class="mb-8">
                    ...
                    <p class="text-gray-400 font-bold text-xs mt-1">Pilih tanggal dan berikan alasan penutupan.</p>
                </div>

                <form wire:submit.prevent="save" class="space-y-6">
                    <div class="space-y-2">
                        <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] ml-2">Tanggal Penutupan</label>
                        <input wire:model="date" type="date" class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-rose-500">
                    ...
                    <div class="space-y-2">
                        ...
                        <input wire:model="reason" type="text" placeholder="Contoh: Libur Lebaran / Maintenance" class="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl text-sm font-bold focus:ring-2 focus:ring-rose-500">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-[2.5rem] shadow-2xl border border-gray-50 overflow-hidden">
                <div class="px-10 py-8 border-b border-gray-50 bg-gray-50/30 flex items-center justify-between">
                    <h2 class="text-sm font-black text-gray-900 uppercase tracking-widest">Daftar Hari Penutupan</h2>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50/20">
                                ...
                                <th class="px-10 py-6 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Alasan / Keterangan</th>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="px-10 py-6 text-right">
                                    <button wire:click="delete({{ $item->id }})" wire:confirm="Hapus tanggal blackout ini?" class="p-3 bg-gray-50 text-gray-400 hover:text-rose-600 hover:bg-rose-50 rounded-xl transition-all shadow-sm">
                            ...
                            <tr>
                                <td colspan="3" class="px-10 py-20 text-center">
                                    <div class="bg-gray-50 rounded-[2rem] p-10 inline-block border-2 border-dashed border-gray-100">
                                        ...
                                        <p class="text-gray-400 font-bold mb-1">Belum ada blackout venue.</p>
                                        <p class="text-[10px] text-gray-300 font-black uppercase tracking-widest leading-relaxed">Gunakan form di samping untuk<br>menambah hari libur.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
